...
Route::get('/test', 'CheckoutController@test')->name('checkout.test');
Route::post('/bkashtoken', 'CheckoutController@bkashtoken')->name('checkout.bkashtoken');
Route::get('/bkashcreatepayment', 'CheckoutController@bkashcreatepayment')->name('checkout.bkashcreatepayment');
Route::get('/bkashexecutepayment', 'CheckoutController@bkashexecutepayment')->name('checkout.bkashexecutepayment');
Route::get('/success', 'CheckoutController@bkashsuccess')->name('checkout.bkashsuccess');
...
Route::get('/checkOTP', 'OtpController@checkOTP')->name('otp.otpcheck');
