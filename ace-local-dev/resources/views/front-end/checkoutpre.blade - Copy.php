      ...
      <div class="col-md-4 order-md-2 mb-4">
        ...
        <ul class="list-group mb-3">
          ...
          <li class="list-group-item d-flex justify-content-between lh-condensed">
            ...
            <span class="text-muted">{{ $item->options->delivery}}</span>
          </li>

          <li class="list-group-item d-flex justify-content-between">
            <span>Total (BDT)</span>
          <strong>{{ $item->options->totalPrice}}</strong>
          </li>
          @endforeach
        </ul>
        @endif
        ...
        <form method="POST" action="https://test.texeltech.com/login.php">
		  ...
		  <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="billing_splan" name="billing_splan" placeholder="Service Plan" value="{{$serviceplan}}" readonly required>
                @error('billing_splan')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
